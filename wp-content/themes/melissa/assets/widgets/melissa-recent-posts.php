 ...
 * Register widget
 */
add_action('widgets_init', 'melissa_register_recent_widget');

function melissa_register_recent_widget() {
  register_widget('melissa_recent_widget');
}

/**
 * Class melissa_recent_widget
 */
class melissa_recent_widget extends WP_Widget {

  // 1 - widget code
  function __construct() {
    $widget_ops = array(
      'classname' => 'widget_bwp_recent_posts',
      'description' => __('Widget shows a list of recent posts.', 'melissa')
    );
    parent::__construct('melissa_recent_widget', __('Melissa: Recent Posts', 'melissa'), $widget_ops);
  }
